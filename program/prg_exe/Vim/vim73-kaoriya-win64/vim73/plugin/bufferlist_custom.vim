...
function! BufferList()
  ...
  let l:i = 0 | while l:i <= l:bufcount | let l:i = l:i + 1
    ...
    let l:bufname = strpart(l:bufname, strridx(l:bufname, "/") + 1, strlen(l:bufname))      "Åöadd
    if strlen(l:bufname)
...
"         let l:bufname = '...' . strpart(l:bufname, strlen(l:bufname) - g:BufferListMaxWidth + 8)  "Åödel
        endif
      endif

      if bufwinnr(l:i) != -1
"       let l:bufname = l:bufname . '*'     "Åödel
        let l:bufname = '*'. l:bufname      "Åöadd
      else                                  "Åöadd
        let l:bufname = ' '. l:bufname      "Åöadd
      endif
...
"       let l:bufname = l:bufname . '+'     "Åödel
      ...
      while strlen(l:bufname) < g:BufferListMaxWidth - 2 "Åömod
